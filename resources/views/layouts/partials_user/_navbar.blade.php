...
<nav class="nav-icons flex items-center gap-1 relative">
    ...
    <div class="search-container relative group">
        ...
        <div class="relative flex items-center h-10 bg-transparent rounded-2xl -mr-4 px-3 transition-all duration-300">
            ...
            <button type="button" id="searchButton"
                ...
                <i class="fa-solid fa-magnifying-glass text-white text-sm md:text-lg"></i>
            </button>

            <!-- SEARCH INPUT -->
            <input id="searchInput" type="text" placeholder="Cari produk..."
                class="bg-transparent border-none w-0 h-full pl-2 text-sm transition-all duration-500 ease-out
    ...
    <div id="searchResults"
        ...
        bg-white shadow-2xl rounded-2xl z-[140] hidden border border-gray-200">

        <!-- HEADER -->
        <div class="sticky top-0 bg-white z-50 px-6 pt-5 pb-4 border-b border-gray-100 flex items-center rounded-t-2xl">
        ...
        <div class="max-h-[70vh] overflow-y-auto">
            ...
            <div id="loadingState" class="hidden flex items-center justify-center py-12 w-full">
                ...
                <div class="flex flex-col items-center justify-center text-center">
                    ...
                    <div class="animate-spin rounded-full h-12 w-12 border-2 border-gray-300 border-t-gray-600">
                    </div>
            ...
            <!-- NO RESULTS -->
            <div id="noResults" class="hidden flex flex-col items-center justify-center py-10 text-center">
    ...
    <!-- OVERLAY -->
    <!-- HAPUS backdrop-blur -->
    <div id="searchOverlay" class="fixed inset-0 bg-black/20 z-[130] hidden">
    </div>
    ...
    <button type="button" onclick="window.location='{{ route('keranjang.index') }}'"
        ...
        <svg class="w-4 h-4 md:w-6 md:h-6 text-white/80 group-hover:text-white transition-colors" fill="none"
        ...
        <span id="cartBadge"
            class="absolute top-0 right-0 bg-gradient-to-r from-red-500 to-red-600 text-white text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center shadow-lg
