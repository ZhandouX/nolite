<footer class="text-white font-sans px-6 py-10 md:py-14" style="background-color: #000;">
    ...
    {{-- DESKTOP --}}
    <div class="max-w-screen mx-auto hidden md:grid grid-cols-3 items-start gap-8">
        ...
        <div class="flex flex-col items-start w-full">
            <div class="flex flex-col items-start gap-2 w-full">
                <a href="https://maps.app.goo.gl/2JL1WGFm4Stzkp3z7"
                   ...
                   class="group relative block rounded-xl overflow-hidden border border-white/20 hover:border-white/60 transition-all duration-300 shadow-lg hover:shadow-white/10 w-full">

                    <iframe
                    src="https://www.google.com/maps/embed?pb=GANTI_DENGAN_EMBED_URL_ASLI"
                    width="100%"
                    height="260"
                    style="border:0; display:block; pointer-events:none; min-height:260px;"
                    loading="lazy"
                    class="w-full">
                </iframe>
    ...
    <div class="flex flex-col items-center justify-start pt-2">
        ...
        <div class="flex flex-col items-center mt-6 max-w-[260px]">
            <p class="italic text-sm leading-relaxed text-white text-center">
...
{{-- MOBILE --}}
<div class="flex flex-col md:hidden items-center gap-6 text-center px-2">
    ...
    <div class="flex flex-col items-center gap-2 w-full px-1">
        ...
        <a href="https://maps.app.goo.gl/2JL1WGFm4Stzkp3z7"
           target="_blank"
           class="group relative block rounded-xl overflow-hidden border border-white/20 w-full">

            <iframe
            src="https://www.google.com/maps/embed?pb=GANTI_DENGAN_EMBED_URL_ASLI"
            width="100%"
            height="220"
            style="border:0; display:block; pointer-events:none; min-height:220px;"
            loading="lazy"
            class="w-full">
        </iframe>
    </a>
