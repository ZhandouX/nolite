                    ...
                    <div class="group bg-white rounded-lg overflow-hidden border border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all duration-300 flex flex-col h-full"
                        ...
                        <div class="p-2 sm:p-2.5 flex flex-col gap-1 sm:gap-1.5 flex-grow">
                            ...
                            <div class="h-5 sm:h-6 flex items-center md:justify-center gap-1.5">
                                @if($adaDiskon)
                                    <p
                                        class="text-left md:text-center text-xs sm:text-lg lg:text-lg md:text-lg font-bold text-red-900 truncate">
                                        Rp{{ number_format($hargaDiskon, 0, ',', '.') }}
                                    </p>
                                    <p
                                        class="text-left md:text-center text-[10px] sm:text-xs md:text-md text-gray-400 line-through truncate flex-shrink-0">
                                        Rp{{ number_format($item->harga, 0, ',', '.') }}
                                    </p>
                                @else
                                    <p
                                        class="text-left md:text-center text-xs sm:text-lg lg:text-lg md:text-lg font-bold text-gray-900 truncate">
                                        Rp{{ number_format($item->harga, 0, ',', '.') }}
                                    </p>
                                @endif
                            </div>
