  ...
  <div class="flex items-center justify-between px-6 py-4 md:py-[17px]">
    ...
    <div class="flex items-center space-x-3">
      ...
      <div class="relative hidden md:block">
        ...
        <input type="text"
          class="pl-10 pr-4 py-2 w-64 lg:w-80 border border-gray-300 dark:border-gray-600 rounded-tl-xl rounded-br-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors duration-200"
