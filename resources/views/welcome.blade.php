...
<body>
    ...
    {{-- ===================================> MODAL <======================================= --}}
        @include('layouts.partials_user.modals.tentangkami') @foreach ($produkTerbaru as $item)
        @include('layouts.partials_user.modal-beli', ['item' => $item]) @include('layouts.partials_user.modal-cart', ['item' => $item]) @endforeach @include('layouts.partials_user.modals.login')
