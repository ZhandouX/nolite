                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-6 transition-colors duration-200">
                            ...
                            <div class="mt-6">
                                ...
                                @error('kategori_id')
                                    <p class="text-sm text-red-500 dark:text-red-400 mt-1 mb-3 flex items-center">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200 dark:border-gray-600">
                            ...
                            <a href="{{ route('admin.produk.index') }}"
                                class="flex-1 inline-flex items-center justify-center px-6 py-3 border border-gray-300 dark:border-gray-600 bg-red-800 dark:bg-red-700 text-white dark:text-gray-300 font-medium rounded-lg hover:bg-gray-400 dark:hover:bg-gray-600 transition-colors duration-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
