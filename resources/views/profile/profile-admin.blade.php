...
@section('content')
    <div class="bg-transparent min-h-screen py-12 px-4 pt-24">
        <div class="max-w-md mx-auto">
            {{-- PROFILE CARD --}}
            <div
                class="bg-white/90 dark:bg-gray-800 backdrop-blur-md rounded-3xl shadow-lg p-8 pt-16 border border-gray-100 dark:border-gray-500 text-center relative overflow-hidden">
                ...
                {{-- FOTO PROFIL (Inisial) --}}
                <div class="relative w-32 h-32 mx-auto rounded-full border-4 border-white bg-gradient-to-br from-gray-600 to-gray-800 dark:bg-gradient-to-br dark:from-cyan-400 dark:to-purple-500 flex items-center justify-center text-white text-6xl font-bold"
                    style="margin-top:-1.5rem;">
                    {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                </div>

                {{-- INFO USER --}}
                <h2 class="mt-5 text-2xl font-semibold text-gray-800 dark:text-gray-300">{{ Auth::user()->name }}</h2>
                ...
                <div class="mt-6 relative">
                    ...
                    <div id="optionsMenu"
                        class="hidden absolute left-1/2 transform -translate-x-1/2 bottom-full mb-3 w-52 bg-white dark:bg-gray-700 rounded-xl shadow-lg border border-gray-100 dark:border-gray-500 z-10 overflow-hidden">
                        <button onclick="openModal('updateProfileModal')"
                            class="block w-full text-left px-4 py-2.5 text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-500 text-sm">
                        ...
                        <button onclick="openDeleteModal()"
                            class="block w-full text-left px-4 py-2.5 text-red-600 hover:bg-rose-400/10 text-sm">
                            <i class="fa-regular fa-trash-can mr-2"></i> Hapus Akun
                        </button>
                        <button onclick="document.getElementById('logoutForm').submit()"
                            class="block w-full text-left px-4 py-2.5 hover:bg-rose-400/10 text-sm text-red-600">
