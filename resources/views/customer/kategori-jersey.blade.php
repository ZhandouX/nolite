        ...
        <main class="w-full md:w-3/4 flex flex-col gap-6">
            ...
            <div class="hidden md:flex justify-end mb-2">
                <div class="relative">
                    ...
                    <div id="sortDropdownMenu"
                        ...
                        <form method="GET" action="{{ route('customer.kategori-jersey') }}" class="flex flex-col">
            ...
            <div id="sortModal"
                ...
                <div class="bg-white rounded-lg p-6 w-11/12 max-w-sm relative">
                    ...
                    <form method="GET" action="{{ route('customer.kategori-jersey') }}" class="flex flex-col gap-3">
                        <button type="submit" name="sort" value="harga_terendah"
...
<style>
    ...
    .banner-container:hover img { transform: scale(1.1); }
    .banner-overlay {
        position: absolute;
        inset: 0;
    ...
    .banner-container:hover .banner-overlay { background-color: rgba(0,0,0,0.5); }
    .banner-overlay h1 {
        color: #fff;
        font-size: 1.75rem;
        font-weight: 800;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    mobileFilterModal.addEventListener('click', e => { if(e.target === mobileFilterModal) mobileFilterModal.classList.add('hidden'); });
    ...
    sortModal.addEventListener('click', e => { if(e.target === sortModal) sortModal.classList.add('hidden'); });
