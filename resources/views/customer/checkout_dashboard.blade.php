...
@section('content')
    <div class="pt-24 max-w-5xl mx-auto px-4 py-8 grid md:grid-cols-3 gap-8">
        ...
        <div class="md:col-span-2 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
            ...
            <form action="{{ route('customer.checkout.dashboard.proses') }}" method="POST" class="space-y-3">
                @csrf
                ...
                {{-- PROVINSI --}}
                <div>
                    <label class="block text-xs font-medium text-gray-700">Provinsi</label>
                    <select name="negara"
                        class="w-full mt-1 border border-gray-300 rounded-md px-3 py-1.5 text-sm focus:ring-1 focus:ring-gray-400"
                        required>
                ...
                {{-- KOTA --}}
                <div>
                    <label class="block text-xs font-medium text-gray-700">Kecamatan, Kota</label>
                ...
                <div class="mt-6 relative">
                    <h3 class="text-sm font-semibold mb-2 text-gray-800">Metode Pembayaran</h3>
                    ...
                    <button type="button" id="payment-toggle"
                        class="w-full flex items-center justify-between border border-gray-300 rounded-md px-3 py-2 text-sm bg-white hover:border-gray-400 transition">
                    ...
                    <div id="payment-options"
                        class="absolute left-0 right-0 mt-2 bg-white border border-gray-200 rounded-md shadow hidden z-10">
                        <ul class="text-sm divide-y divide-gray-200">
                            <li class="px-3 py-2 hover:bg-gray-700 hover:text-white cursor-pointer"
