    ...
    <div class="container mx-auto px-0 py-8 pt-24">
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <aside class="w-full md:w-1/4 bg-white border border-gray-200 rounded-lg p-4">
                <form method="GET" action="{{ route('customer.kategori-hoodie') }}">
                    {{-- SEARCH --}}
                    <div class="mb-6">
                        <div class="relative">
            ...
            <main class="w-full md:w-3/4">
                ...
                <div class="relative h-56 mb-8 rounded-lg overflow-hidden shadow-lg w-[115%] ml-0 -mr-8 group">
                    <img src="{{ asset('assets/images/banner/hoodie-1.jpg') }}" alt="Banner T-Shirt"
                    ...
                    <div
                        ...
                        <h1 class="text-4xl md:text-5xl font-extrabold text-white">Hoodie</h1>
                    </div>
                </div>

                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold">Produk Hoodie</h1>
                    <form method="GET" action="{{ route('customer.kategori-hoodie') }}">
...
@push('script')
    ...
    <script>
        function handleCategoryClick(radio, categoryUrl, allUrl) {
            // Jika radio sudah tercentang dan diklik lagi -> arahkan ke halaman semua produk
            if (radio.dataset.waschecked === "true") {
                radio.checked = false;
                radio.dataset.waschecked = "false";
                window.location.href = allUrl; // arahkan ke halaman semua produk
            } else {
                // tandai radio ini sebagai sudah diklik
        ...
        // Saat load halaman, tandai radio aktif
