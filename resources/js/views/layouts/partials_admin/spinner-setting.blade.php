...
<div class="gear-bubble-wrapper">
    ...
    <div class="gear-popup shadow" id="gearPopup">
        <div class="popup-header text-center">
            ...
            <button type="button" class="btn-close" id="closeGearPopup" aria-label="Close"></button>
        </div>
        ...
        <div class="popup-body">
            ...
            {{-- TAMBAH BERITA --}}
            <a href="{{ route('admin.news.create') }}" class="popup-item d-flex align-items-center">
            ...
            {{-- LIHAT BERITA --}}
            <a href="{{ route('admin.news.index') }}" class="popup-item d-flex align-items-center">
                ...
                <ul class="list-group">
                    <li class="list-group-item text-center bg-dark-grey">
                        <a href="#" class="btn btn-sm btn-warning text-white btn-lg fw-bold w-100 mb-2"
                            data-bs-toggle="collapse" data-bs-target="#rekapBulanan">
                            <i class="fa fa-calendar"></i>
                            Rekap Bulanan
                        </a>

                        {{-- SUB-DROPDOWN (BULANAN) --}}
                    ...
                    <li class="list-group-item text-center bg-dark-grey">
                        <a href="#" class="btn btn-sm btn-warning text-white btn-lg fw-bold w-100 mb-2"
                            data-bs-toggle="collapse" data-bs-target="#rekapTahunan">
                            <i class="fa fa-calendar-o"></i>
                            Rekap Tahunan
                        </a>

                        {{-- SUB-DROPDOWN (TAHUNAN) --}}
