<div class="col-lg-12 dark-theme news-create-card">
    <div class="card-container">
        <div class="header-create-card">
            ...
            <a href="{{ route('super-admin.twitter.index') }}" class="btn btn-danger">
        ...
        <form action="{{ route('super-admin.twitter.update', $twitter->id) }}" method="POST"
            ...
            <div class="form-container">
                ...
                <div class="left-column">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title', $twitter->title) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="url" id="link" name="link" value="{{ old('link', $twitter->link) }}"
                                class="@error('link') error @enderror" placeholder="https://twitter.com/watch?v=xxxx"
                                required>
                        </div>
                        @error('link')
                            <p class="error-text">{{ $message }}</p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="date" id="content_date" name="content_date"
                                value="{{ old('content_date', $twitter->content_date->format('Y-m-d')) }}"
