<div class="col-lg-12 dark-theme news-create-card">
    <div class="card-container">
        <div class="header-create-card">
            ...
            <a href="{{ route('super-admin.instagram.index') }}" class="btn btn-danger">
        ...
        <form action="{{ route('super-admin.instagram.update', $instagram->id) }}" method="POST"
            ...
            <div class="form-container">
                ...
                <div class="left-column">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title', $instagram->title) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="url" id="link" name="link" value="{{ old('link', $instagram->link) }}"
                                class="@error('link') error @enderror" placeholder="https://instagram.com/watch?v=xxxx"
                                required>
                        </div>
                        @error('link')
                            <p class="error-text">{{ $message }}</p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="date" id="content_date" name="content_date"
                                value="{{ old('content_date', $instagram->content_date->format('Y-m-d')) }}"
