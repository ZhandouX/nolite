<div class="col-lg-12 dark-theme news-create-card">
    <div class="card-container">
        <div class="header-create-card">
            <h4 class="title">
                <i class="mdi mdi-instagram icon-smd"></i>
                Tambah Konten Instagram
            </h4>
        ...
        {{-- SHIMMER ANIMATION --}}
        <div>
            <div class="youtube-create mb-2"></div>
        </div>

        <hr class="w-100">

        <form class="form-news-create-card" action="{{ route('super-admin.instagram.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="left-column">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                            ...
                            placeholder="Masukkan judul konten instagram">
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="url" 
                                name="link" 
                                id="link" 
                                placeholder="https://contoh.com/konten" 
                                value="{{ old('link') }}" 
