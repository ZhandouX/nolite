<div class="col-lg-12 dark-theme news-create-card">
    <div class="card-container">
        <div class="header-create-card">
            <h4 class="title">
                <i class="fa fa-tiktok icon-smd"></i>
                Tambah Konten Tiktok
            </h4>
            <a href="{{ route('super-admin.tiktok.index') }}">
        ...
        <form action="{{ route('super-admin.tiktok.store') }}" method="POST" enctype="multipart/form-data" class="form-news-create-card">
            @csrf
                ...
                <div class="left-column">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" required
                            class="@error('title') error @enderror" placeholder="Masukkan judul konten tiktok">
                        @error('title')
