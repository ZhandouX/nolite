<div class="col-lg-12 dark-theme news-create-card">
    <div class="card-container">
        <div class="header-create-card">
            <h4 class="title">
                <i class="mdi mdi-web icon-smd"></i>
                Tambah Konten Website
            </h4>
            <a href="{{ route('super-admin.website.index') }}">
        ...
        <form action="{{ route('super-admin.website.store') }}" method="POST" enctype="multipart/form-data" class="form-news-create-card">
            @csrf
                ...
                <div class="left-column">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" required
                            class="@error('title') error @enderror" placeholder="Masukkan judul konten website">
                        @error('title')
