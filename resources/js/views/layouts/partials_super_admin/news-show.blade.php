            ...
            <div class="row">
                <div class="d-sm-flex justify-content-between align-items-start">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold"><i class="mdi mdi-information icon-smd"></i>
                    ...
                    <div>
                        <a href="{{ route('super-admin.news.index') }}" class="btn btn-light btn-lg mb-0 me-0">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <p class="card-description mb-0">
                                <span class="badge badge-danger">{{ $news->category }}</span>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-column gap-2">
                                        <a href="{{ route('super-admin.news.edit', $news) }}"
                                            class="btn btn-warning btn-lg text-white w-100">
                                            <i class="mdi mdi-pencil"></i> Edit Berita
                                        </a>

                                        <form action="{{ route('super-admin.news.destroy', $news) }}" method="POST"
