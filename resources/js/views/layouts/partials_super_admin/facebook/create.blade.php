<div class="col-lg-12 dark-theme news-create-card">
    <div class="card-container">
        <div class="header-create-card">
            <h4 class="title">
                <i class="mdi mdi-facebook icon-smd"></i>
                Tambah Konten Facebook
            </h4>
        ...
        <form class="form-news-create-card" action="{{ route('super-admin.facebook.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="left-column">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                            ...
                            placeholder="Masukkan judul konten facebook">
                        @error('title')
