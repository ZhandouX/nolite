@if ($paginator->hasPages())
    <nav aria-label="Pagination Navigation" class="pagination-container">
        <ul class="pagination-list">
            ...
            @if ($paginator->currentPage() > 3)
                <li class="hidden-sm">
                    <a href="{{ $paginator->url(1) }}" class="pagination-link" title="Halaman Pertama">««</a>
                </li>
            @endif
            ...
            @else
                <li>
                    <a href="{{ $paginator->previousPageUrl() }}" class="pagination-link" rel="prev" title="Halaman Sebelumnya">«</a>
                </li>
            @endif
            ...
            @if ($paginator->hasMorePages())
                <li>
                    <a href="{{ $paginator->nextPageUrl() }}" class="pagination-link" rel="next" title="Halaman Selanjutnya">»</a>
                </li>
            @else
            ...
            @if ($paginator->currentPage() < $last - 2)
                <li class="hidden-sm">
                    <a href="{{ $paginator->url($last) }}" class="pagination-link" title="Halaman Terakhir">»»</a>
                </li>
            @endif
        </ul>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Tambahkan efek loading saat klik halaman
