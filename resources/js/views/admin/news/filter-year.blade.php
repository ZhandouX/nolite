    ...
    <div class="row justify-content-start g-3">
        ...
        <div class="col-md-6">
            <div class="card modern-form-card">
                <div class="card-body">
                    <h4 class="card-title"><i class="mdi mdi-clipboard-text-outline icon-smd"></i> Rekap Berita / Tahun</h4>

                    {{-- FORM EXPORT PDF --}}
                    <form action="{{ route('admin.news.export-yearly-report') }}" method="GET" id="exportFormYearly">
                        <div class="mb-3">
        ...
        <div class="col-md-6">
            <div class="card modern-list-card">
                <div class="card-body">
                    ...
                    {{-- LIST BERITA --}}
                    <div id="newsListYearly" class="row g-3 mt-2">
                        {{-- Konten berita akan di-render oleh JS --}}
                    </div>
...
@push('scripts')
    <script>
        // Fungsi AJAX fetch berita tahunan dengan pagination
        function fetchNewsYearly(page = 1) {
            ...
            fetch(`{{ route('admin.news.filter-year.list') }}?year=${year}&page=${page}`, {
                ...
                .then(response => {
                    ...
                    if (response.data.length > 0) {
                        ...
                        <div class="col-12">
                            <div class="no-news-state">
                                ...
                                <p>Tidak ada berita untuk tahun yang dipilih.</p>
                            </div>
                        </div>`;
                    }
                    ...
                    // Render pagination
                    renderPagination(response, fetchNewsYearly);

                    attachNewsCardEvents();
                });
        }

        // Render pagination dengan callback dinamis (yearly / monthly)
        function renderPagination(response, fetchFunction) {
        ...
        // Fetch berita awal saat halaman di-load
        document.addEventListener('DOMContentLoaded', () => fetchNewsYearly());

        // Event saat input tahun berubah
