        ...
        <div class="col-md-6">
            <div class="card modern-form-card">
                <div class="card-body">
                    ...
                    {{-- SUBMIT EXPORT PDF --}}
                    <form action="{{ route('super-admin.news.export-yearly-report') }}" method="GET" id="exportFormYearly">
                        <div class="mb-3">
...
@push('scripts')
    <script>
        ...
        function fetchNewsYearly(page = 1) {
            ...
            fetch(`{{ route('super-admin.news.filter-year.list') }}?year=${year}&page=${page}`, {
